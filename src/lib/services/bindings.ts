...
export const commands = {
	 ...
	 */
	ttsListVoices: (providerId: string | null) => typedError<VoiceInfo[], MythicError>(__TAURI_INVOKE("tts_list_voices", { providerId })),
	/**
	 ...
	 */
	ttsSetCharacterVoice: (characterId: string, voiceId: string | null, voiceProviderId: string | null) => typedError<Character_Serialize, MythicError>(__TAURI_INVOKE("tts_set_character_voice", { characterId, voiceId, voiceProviderId })),
	/**
	 ...
	 *  several hundred KB.
	 */
	ttsTestSpeak: (text: string, voiceId: string, providerId: string | null) => typedError<string, MythicError>(__TAURI_INVOKE("tts_test_speak", { text, voiceId, providerId })),
	/**
	 ...
	 */
	ttsReplayMessage: (conversationId: string, messageId: string, text: string, voiceId: string, providerId: string | null) => typedError<null, MythicError>(__TAURI_INVOKE("tts_replay_message", { conversationId, messageId, text, voiceId, providerId })),
	/**
