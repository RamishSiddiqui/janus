...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#9075F2` | Gradient start, CTA, accents |
| Secondary | `#CDA15F` | Gradient end, hover states |
| Text (light bg) | `#211F2E` | Body text on white/light |
| Text (dark bg) | `#ECE9F6` | Body text on dark |
| Background (light) | `#F6F3EE` | Light mode |
| Background (dark) | `#0A0A13` | Dark mode |
